...
[README](../README.md) in the top-level directory of the Gollem distribution.
...
1. A working Horde installation.
   ...
   Gollem runs within the [Horde Application Framework](http://www.horde.org/apps/horde),
   a set of common tools for web applications written in PHP. You must install
   Horde before installing Gollem.

   > **Important:** Gollem H5 requires version 5.0.2+ of the Horde Framework -
   > earlier versions of Horde will **not** work.

   > **Important:** Be sure to have completed all of the steps in the
   > [horde/doc/INSTALL](../../horde/doc/INSTALL) file for the Horde Framework
   > before installing Gollem. Many of Gollem's prerequisites are also Horde
   > prerequisites. Additionally, many of Gollem's optional features are
...
2. The following PHP capabilities:
   ...
   b. SQL support [OPTIONAL]
      ...
      reference the Horde installation document
      ([horde/doc/INSTALL](../../horde/doc/INSTALL)).
...
First follow the instructions in [horde/doc/INSTALL](../../horde/doc/INSTALL)
to prepare a PEAR environment for Horde and install the Horde Framework.
